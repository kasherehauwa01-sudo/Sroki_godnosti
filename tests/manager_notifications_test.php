...
$batches = [
    ['id' => 1, 'code' => 'ЖС1111', 'article' => '1', 'name' => 'Товар 1'],
    ['id' => 2, 'code' => 'жс2222', 'article' => '2', 'name' => 'Товар 2'],
    ['id' => 3, 'code' => 'ЖС3333', 'article' => '3', 'name' => 'Товар 3'],
];
$assignments = [
    ['code' => 'жс1111', 'manager_name' => 'Кульченко Лилия', 'manager_email' => 'kulchenko@example.test'],
...
$expected = [
    'kulchenko@example.test' => ['ЖС1111', 'жс2222'],
