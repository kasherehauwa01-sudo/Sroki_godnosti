...
foreach (['filterExpiryFrom', 'filterExpiryTo', 'clearRegistrySearchButton', 'registryExportDialog', 'exportRegistryXlsxButton', 'exportRegistryXlsButton', 'Выберите формат таблицы'] as $fragment) {
...
foreach (['filters.expiry_from', 'filters.expiry_to', 'clearRegistrySearch', "downloadRegistryExport('xlsx')", "downloadRegistryExport('xls')", "addEventListener('click', openRegistryExportDialog)"] as $fragment) {
