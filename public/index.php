        ...
        <section class="panel" id="tab-help">
            ...
            <div class="card help-card help-subpanel active" data-help-panel="description">
                ...
                <ul>
                    ...
                    <li>Автозагрузка запускается по расписанию и ищет письмо текущей даты.</li>
                    <li>Если письмо не найдено, скрипт может повторять поиск каждый час в течение заданного окна.</li>
